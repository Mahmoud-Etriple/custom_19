...
class ins_account_financial_report(models.Model):
    ...
    def _get_children_by_order(self, strict_range):
        ...
        if not strict_range:
            # env.ref() requires a module-qualified external id; the bare names
            # used previously raised ValueError whenever strict_range was False.
...
class CommonXlsxOut(models.TransientModel):
    ...
    _description = "Common XLSX Output"
