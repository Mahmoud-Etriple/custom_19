...
# Odoo 19: xlsxwriter is no longer re-exported by odoo.tools.misc; the
# sheet-name sanitising patch is applied globally in odoo/_monkeypatches.
import xlsxwriter
...
class InsAnalyticReport(models.TransientModel):
    ...
    _description = "Analytic Report Wizard"
    ...
    def _compute_display_name(self):
        for record in self:
            record.display_name = 'Analytic Report'
